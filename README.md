...
<img width="1493" height="983" alt="grafik" src="https://github.com/user-attachments/assets/751566be-24bb-4573-9b6f-567df86e64e7" />


AmigaED brings project management, syntax highlighting, and one-click builds to AmigaOS 1.3/3.x cross-development, with out-of-the-box support for vbcc, m68k-amigaos-gcc, vasm, GNU as and SAS/C — plus integrated UAE emulator launching, so you can edit, compile, and test your Amiga software without ever leaving the editor.

## Features

> **Status:** BETA. Core functionality works and has been tested during development, but it hasn't seen broad real-world use yet — expect rough edges, and please [file an issue](../../issues) if you hit one.
...
- Syntax highlighting for:
  ...
  - Makefiles, AmigaShell scripts, Pascal, plain text, assembler
...
- "New Project" templates:
  ...
  - MUI 5 GUI skeleton
  - Assembler templates for vasm and GNU as
