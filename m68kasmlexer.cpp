...
QString M68kAsmLexer::description(int style) const
{
    ...
    case Mnemonic:
        return QObject::tr("Mnemonic");
    case Directive:
        return QObject::tr("Directive");
    case Register:
        return QObject::tr("Register");
    case Number:
...
QColor M68kAsmLexer::defaultColor(int style) const
{
    ...
    case Directive:
        return QColor(0x80, 0x00, 0x80); // purple
    case Register:
        return QColor(0xb2, 0x22, 0x22); // firebrick
    case Number:
        return QColor(0x00, 0x80, 0x80); // teal
    case Label:
        return QColor(0xb8, 0x86, 0x0b); // dark goldenrod
    default:
...
const QSet<QString> &M68kAsmLexer::mnemonics()
{
    ...
    static const QSet<QString> kw = { // data movement
                                      "move",
                                      "movea",
                                      "movem",
                                      "movep",
...
{
    static const QSet<QString> kw = { // vasm/devpac-style (dotless) directives
                                      "dc",
                                      "ds",
                                      "dcb",
                                      "equ",
...
{
    static const QSet<QString> kw = {"d0", "d1",  "d2",  "d3", "d4", "d5", "d6", "d7",
